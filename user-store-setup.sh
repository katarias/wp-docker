...
##### Install and configure Wordpress #####
        ...
        docker exec -i --workdir /var/www/html ${User}_php wp --allow-root core install --url=$userdomain --title="WP-CLI" --admin_user=admin --admin_password=$wppass --admin_email=admin@$userdomain
